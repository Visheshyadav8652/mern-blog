...
hoistedDependencies:
  ...
  flatted@3.3.2:
    flatted: private
  flowbite-datepicker@1.3.2(rollup@4.30.1):
    flowbite-datepicker: private
  flowbite@2.5.1(rollup@4.30.1):
    flowbite: private
  for-each@0.3.3:
    for-each: private
...
pendingBuilds: []
prunedAt: Sat, 11 Jan 2025 12:35:10 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
virtualStoreDir: D:\Users\Vishesh Yadav\REACTjs\client\node_modules\.pnpm
